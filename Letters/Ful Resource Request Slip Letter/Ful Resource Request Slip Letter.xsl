                ...
                <div class="messageBody">
                     ...
                     <table cellspacing="0" cellpadding="5" border="0">
                        ...
                        <tr>
                            <td>
                        <b>@@requested_for@@: </b>
                            <xsl:value-of select="notification_data/user_for_printing/name"/> (<xsl:value-of select="notification_data/user_for_printing/email"/>)</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <xsl:if test="notification_data/phys_item_display/call_number != ''">
                                <td><h2><b>@@call_number@@: </b><xsl:value-of select="notification_data/phys_item_display/call_number"/> <xsl:if test="notification_data/phys_item_display/issue_level_description !=''">(<xsl:value-of select="notification_data/phys_item_display/issue_level_description"/>)</xsl:if></h2></td>
                            </xsl:if>
